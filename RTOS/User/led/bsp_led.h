...
#define LED2_OFF			GPIO_WriteBit(LED2_GPIO_PORT, LED2_PIN, Bit_SET)
#define LED2_ON				GPIO_WriteBit(LED2_GPIO_PORT, LED2_PIN, Bit_RESET)

#define LED3_OFF			GPIO_WriteBit(LED3_GPIO_PORT, LED3_PIN, Bit_SET)
#define LED3_ON				GPIO_WriteBit(LED3_GPIO_PORT, LED3_PIN, Bit_RESET)
